"""10k-step optimizer variant comparison: {Muon, Mousse, Muon-VS, Adam} × 3 seeds.

Tests whether curvature-aware (Mousse) or variance-scaled (Muon-VS) Muon
variants improve over base Muon at longer training horizons.
"""
import sys
import json
import time
